...
<%@ page import = "java.sql.*,java.util.*,com.slg.bbs.*" %>
<%!
private void tree(List<Article> articles,Connection con,int id,int grade){
...
//System.out.println("sdafsdfasdfasdfasdfasdfasdfasdfasdf");
                ...
                <tbody>
                  ...
                  <tr class="jive-even">
                    ...
                    <td nowrap="nowrap" width="1%">
                    	<a href="delete.jsp?id= &isLeaf=<%=a.isLeaf() %> &pid=<%=a.getPid() %> ">DEL</a>
                    </td>
